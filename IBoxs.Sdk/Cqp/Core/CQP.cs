...
namespace IBoxs.Sdk
{
    ...
    {
        private const string DllName = "OQapi.dll";

        [DllImport(DllName, EntryPoint = "Api_SendMsg", CharSet = CharSet.Ansi)]
        public static extern IntPtr Api_SendMsg(string rotbotQQ, int type, string group, string qq, string Msg, int MsgID, int ty);
